    ...
    private static function getAgreement($created_by, $time)
    {
        return [
            [
                ...
                'hash' => md5('/api/v1/system/agreement/index'),
            ...
            [
                ...
                'hash' => md5('/api/v1/system/agreement/save'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/agreement/view'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/agreement/delete'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ]
    ...
    private static function getComplaint($created_by, $time)
    {
        ...
        return [
            [
                ...
                'hash' => md5('/api/v1/system/complaint/index'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/complaint/save'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/complaint/view'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/complaint/delete'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ]
    ...
    private static function getImage($created_by, $time)
    {
        ...
        return [
            [
                ...
                'hash' => md5('/api/v1/system/images/index'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/images/save'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/images/view'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/images/upload'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/images/delete'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ]
    ...
    private static function getTag($created_by, $time)
    {
        return [
            [
                ...
                'hash' => md5('/api/v1/system/tag/index'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/tag/save'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/tag/view'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/tag/delete'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ]
    ...
    private static function getUnit($created_by, $time)
    {
        return [
            [
                ...
                'hash' => md5('/api/v1/system/unit/index'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/unit/save'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/unit/view'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/unit/delete'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ]
    ...
    private static function getConfig($created_by, $time)
    {
        return [
            [
                ...
                'hash' => md5('/api/v1/system/config/index'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/config/save'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/config/view'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/config/delete'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ]
    ...
    private static function getNavigation($created_by, $time)
    {
        return [
            [
                ...
                'hash' => md5('/api/v1/system/navigation/index'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/navigation/save'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/navigation/view'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/navigation/delete'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ]
    ...
    private static function getRole($created_by, $time)
    {
        return [
            [
                ...
                'hash' => md5('/api/v1/system/role/index'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/role/save'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/role/view'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/role/delete'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ]
    ...
    private static function getManager($created_by, $time)
    {
        return [
            [
                ...
                'hash' => md5('/api/v1/system/manager/index'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/manager/save'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/manager/view'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/manager/info'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/manager/delete'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ]
    ...
    private static function getActionLog($created_by, $time)
    {
        return [
            [
                ...
                'hash' => md5('/api/v1/system/action-log/index'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/action-log/delete'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ]
    ...
    private static function getRouters($created_by, $time)
    {
        return [
            [
                ...
                'hash' => md5('/api/v1/system/router/index'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/router/save'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/router/delete'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ],
            [
                ...
                'hash' => md5('/api/v1/system/router/registered-route'),
                'created_by' => $created_by,
                'created_at' => $time,
                'updated_at' => $time
            ]
