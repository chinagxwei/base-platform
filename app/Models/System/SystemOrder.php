...
{
    use HasFactory, SoftDeletes, Uuids, CreatedRelation, UpdatedRelation, WalletRelation, UnitRelation, SearchData, SignData;
    ...
    protected $fillable = [
        ...
        'wallet_id', 'order_category', 'unit_id', 'pay_method',
