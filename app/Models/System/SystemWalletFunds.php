 ...
 */
class SystemWalletFunds extends BaseDataModel
{
    use HasFactory, SoftDeletes, Uuids, CreatedRelation, UpdatedRelation, UnitRelation, WalletRelation, OrderRelation, SignData, SearchData;

    protected $table = 'system_wallet_funds';
