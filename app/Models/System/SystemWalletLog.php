 ...
 */
class SystemWalletLog extends BaseDataModel
{
    use HasFactory, SoftDeletes, Uuids, CreatedRelation, UpdatedRelation, WalletRelation, OrderRelation, SearchData, SignData;

    protected $table = 'system_wallet_logs';
