...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('member_wechat_office_accounts', function (Blueprint $table) {
            ...
            $table->tinyInteger('sex')->unsigned()->nullable()->comment('性别 1男 2女');
    ...
    {
        Schema::dropIfExists('member_wechat_office_accounts');
    }
};
